...
const STRAPLINES = {
  ...
  'Leeds United|Millwall':
    '170 miles apart, north vs south, and one of the most genuinely volatile fixtures in English football. The rivalry barely existed before 1985 — the clubs spent almost four decades in different divisions — but it caught fire during their League One years (2007–2010). The 2007/08 fixture at Elland Road was marked by serious disorder, with mounted police charging to separate supporters. In the 2008/09 play-off semi-final, a record 37,036 packed Elland Road and Millwall went through amid a controversial pitch invasion. There was the chaotic 4-3 at Elland Road in January 2018 where ten-man Leeds threw away a 3-2 lead. Both clubs carry the weight of 1970s/80s hooligan firm reputations — the Leeds Service Crew and the Millwall Bushwackers — which continues to colour the atmosphere at every meeting. Leeds fans rank Millwall as a joint-third rival; Millwall\'s primary focus is West Ham, making this a rivalry weighted more heavily on one side, but genuinely mutual.',
  ...
  'Stoke City|Wolverhampton Wanderers':
    'The Staffordshire Derby. Wolverhampton historically sat within the boundaries of Staffordshire, and the two clubs first met on 17 November 1888 — Wolves winning 1-0. Since then they\'ve played over 150 times, Wolves edging it with around 65 wins to Stoke\'s 50. Neither side rates this as their defining rivalry — Wolves\' big one is the Black Country Derby with West Brom, Stoke save their sharpest feelings for Port Vale — which gives the fixture a more workmanlike edge than the hottest derbies on the list. Still, 28 miles up the M6 and a shared Midlands identity means there\'s always local pride at stake. With Wolves dropping into the Championship for 2026/27, the fixture is back on the menu.',
